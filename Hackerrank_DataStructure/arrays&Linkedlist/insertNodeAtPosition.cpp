...
SinglyLinkedListNode* insertNodeAtPosition(SinglyLinkedListNode* head , int data, int position) {
    SinglyLinkedListNode* newNode = new SinglyLinkedListNode(data); 
     ...
     {
         // insert the node at the begining and make the new node  the head node 
         newNode ->next = head ;
         head = newNode ; 
     ...
     else 
     {
         ...
         newNode->next  = current->next  ; // insert the element right after the current 
         current->next = newNode ;
         
       
         
     }
      return head ;  // returning the head node as its ref to all the linkedlist items 
